...
function Brokerage() {
  return (
    <div className="conatiner mx-5 p-5 text-muted">
      <h3 className="my-5">Charges explained</h3>
      <div className="row">
        <div className="col">
          <h6 className="py-3">Securities/Commodities transaction tax</h6>
          ...
          <h6 className="py-3">Transaction/Turnover Charges</h6>
          <p style={{ fontSize: ".9rem" }}>
          ...
          <h6 className="py-3">Call & trade</h6>
          <p style={{ fontSize: ".9rem" }}>
            Additional charges of ₹50 per order for orders placed through a
            dealer at Zerodha including auto square off orders.
          </p>
          <h6 className="py-3">Stamp charges</h6>
          <p style={{ fontSize: ".9rem" }}>
          ...
          <h6 className="py-3">NRI brokerage charges</h6>
          <p style={{ fontSize: ".9rem" }}>
            <ul>
              <li>
          ...
          <h6 className="py-3">Account with debit balance</h6>
          <p style={{ fontSize: ".9rem" }}>
          ...
          <h6 className="py-3">Margin Trading Facility (MTF)</h6>
          <p style={{ fontSize: ".9rem" }}>
            <ul>
              <li>
        ...
        <div className="col">
          <h6 className="py-3">GST</h6>
          <p style={{ fontSize: ".9rem" }}>
            Tax by the government when transacting on the exchanges. Charged as
            above on both buy and sell sides when trading equity delivery.
            Charged only on selling side when trading intraday or on F&O.
          </p>
          <h6 className="py-3">SEBI Charges</h6>
          <p style={{ fontSize: ".9rem" }}>
            Charged at ₹10 per crore + GST by Securities and Exchange Board of
            India for regulating the markets.{" "}
          </p>
          <h6 className="py-3">DP (Depository participant) charges</h6>
          <p style={{ fontSize: ".9rem" }}>
          ...
          <h6 className="py-3">Pledging charges</h6>
          <p style={{ fontSize: ".9rem" }}>
            ₹30 + GST per pledge request per ISIN.
          </p>
          <h6 className="py-3">AMC (Account maintenance charges)</h6>
          <p style={{ fontSize: ".9rem" }}>
          ...
          <h6 className="py-3">Corporate action order charges</h6>
          <p style={{ fontSize: ".9rem" }}>
            ₹20 plus GST will be charged for OFS / buyback / takeover /
            delisting orders placed through Console.{" "}
          </p>
          <h6 className="py-3">Off-market transfer charges</h6>
          <p style={{ fontSize: ".9rem" }}>₹25 per transaction.</p>
          <h6 className="py-3">Physical CMR request</h6>
          <p style={{ fontSize: ".9rem" }}>
            First CMR request is free. ₹20 + ₹100 (courier charge) + 18% GST for
            subsequent requests.
          </p>
          <h6 className="py-3">Payment gateway charges</h6>
          <p style={{ fontSize: ".9rem" }}>
            ₹9 + GST (Not levied on transfers done via UPI)
          </p>
          <h6 className="py-3">Delayed Payment Charges</h6>
          <p style={{ fontSize: ".9rem" }}>
